var Animation = (function () {
    ...
    Animation.fsequence = function (a, b) {
        var r = [];
        for (var i = a; i < (a + b); i++)
            r.push(i);
        return r;
    };
    Animation.ft_repate = function (n, t) {
        var r = [];
        for (var i = 0; i < n; i++)
            r.push(t);
        return r;
    };
    Animation.FrameTime = 1.0 / 30.0;
    return Animation;
})();
var AnimationManager = (function () {
    function AnimationManager(spritesheet, width_per_frame, height_per_frame) {
        this.animate = true;
        this.animations = {};
    ...
    AnimationManager.prototype.add_animation = function (name, frame_sequence, frame_time, repeat) {
