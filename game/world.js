...
var DimensionPlane = (function () {
    function DimensionPlane() {
    }
    return DimensionPlane;
})();
var World = (function () {
    ...
    World.prototype.setup_blood_emitter = function () {
    ...
    World.prototype.setup_dimension_emitter = function () {
        var pm = new ParticleEmitter(new vec3([1, 1, 1]));
        pm.position = new vec3([0, 0, 0]);
        pm.textures = [particle_texture_basic];
        pm.spawn_max = -1;
    ...
    World.prototype.setup_ex_emitter = function () {
        var pm = new ParticleEmitter(new vec3([1, 1, 1]));
        pm.position = new vec3([0, 0, 0]);
        pm.textures = [particle_texture_basic];
        pm.spawn_max = -1;
    ...
    World.prototype.toggle_angle = function () {
        ...
        pickup_sound.play();
        this.angle_tween.to({ current_view_angle: this.next_view_angle }, 180.0).on(function (value) {
    ...
    World.prototype.bais_towards_camera = function (pm) {
    ...
    World.prototype.update = function (dt) {
        ...
        for (var bullet_index = 0; bullet_index < this.bullets.length; bullet_index++) {
            ...
            var bullet_hit = this.check_collision_bullet(bullet, dt);
    ...
    World.prototype.push_particles = function (temp) {
    ...
    World.prototype.push_particle_emitter = function (pm, temp) {
    ...
    World.prototype.aabb = function (Ap, As, Bp, Bs) {
        var hit = {
            intersect: false,
    ...
    World.prototype.check_collision_world = function (obj, dt) {
        var min_dim = 0;
        var max_dim = 0;
    ...
    World.prototype.check_collision_bullet = function (obj, dt) {
    ...
    World.prototype.check_collision = function (obj, dt) {
        var current_tile_x = ((obj.position.x) / TILE_SIZE) | 0;
        var current_tile_y = ((obj.position.y) / TILE_SIZE) | 0;
        // TODO: Test the world bounds
        var max_x = (((obj.position.x + obj.size.x * 0.5) / TILE_SIZE) | 0) + 1 - current_tile_x;
    ...
    World.prototype.remove_object = function (obj) {
        ...
        i = this.pushables.indexOf(obj);
        if (i > -1) {
            this.pushables.splice(i, 1);
        }
    };
    World.prototype.enemy_attack_weapon = function (time, dt, enemy, weapon, use_z) {
        if (use_z === void 0) { use_z = false; }
        ...
        if (hit.intersect) {
            ...
            if (!use_z)
                d.mul(this.view_inverse_normal);
    ...
    World.prototype.player_attack_weapon = function (time, dt, player, weapon) {
    ...
    World.prototype.player_change_dimension = function (time, dt) {
    ...
    World.prototype.damage_player = function (damage) {
        this.player.do_damage(damage);
        this.blood_particle_emitter.position = this.player.position;
        this.blood_particle_emitter.spawn_x(engine.time, 0.0, World.SPAWN_BLOOD_COUNT);
    };
    World.SPAWN_BLOOD_COUNT = 30;
    World.SPAWN_DIMENSION_COUNT = 100;
    World.SPAWN_EX_COUNT = 200;
    return World;
})();
